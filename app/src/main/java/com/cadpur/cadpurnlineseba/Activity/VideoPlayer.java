package com.cadpur.cadpurnlineseba.Activity;

import static com.cadpur.cadpurnlineseba.Utils.MasterJubaYoutube.BUFFERING;
import static com.cadpur.cadpurnlineseba.Utils.MasterJubaYoutube.CUED;
import static com.cadpur.cadpurnlineseba.Utils.MasterJubaYoutube.ENDED;
import static com.cadpur.cadpurnlineseba.Utils.MasterJubaYoutube.PAUSED;
import static com.cadpur.cadpurnlineseba.Utils.MasterJubaYoutube.PLAYING;
import static com.cadpur.cadpurnlineseba.Utils.MasterJubaYoutube.UNSTARTED;
...
import com.cadpur.cadpurnlineseba.Utils.Config;
import com.cadpur.cadpurnlineseba.Utils.ExpandableHeightGridView;
import com.cadpur.cadpurnlineseba.Utils.MasterJubaYoutube;
...
public class VideoPlayer extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    public static ArrayList<VideoDescription> arrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (comingFrom.contentEquals("LiveTV")){
            arrayList.add(new VideoDescription("sM8J3PpnxgM", "সরাসরি সময় টিভি", "SOMOY TV LIVE | সময় টিভি লাইভ | সরাসরি সময় টিভি") );
            arrayList.add(new VideoDescription("F-POY4Q0QSI", "সরাসরি আল জাজিরা ইংরেজি | ", "Channel 24 Live | সরাসরি চ্যানেল 24 লাইভ") );
            arrayList.add(new VideoDescription("G9p9WqiEA_A", "সরাসরি ডিবিসি নিউজ টেলিভিশন", "Al Jazeera English | Live TV| সরাসরি আল জাজিরা ইংরেজি |") );
            arrayList.add(new VideoDescription("t0koeCylb3s", "সরাসরি এনটিভি ", "NTV Live | সরাসরি এনটিভি") );
            arrayList.add(new VideoDescription("5f-u1Q8NYqo", "সরাসরি যমুনা টিভি", "Jamuna TV | সরাসরি যমুনা টিভি") );
            arrayList.add(new VideoDescription("cgiNYtMWFss", " সরাসরি এটিএন নিউজ", "ATN News Live TV | সরাসরি এটিএন নিউজ") );
            arrayList.add(new VideoDescription("vSHelsYpvkc", "সরাসরি  জি টিভি অফিসিয়াল টিভি ", "G TV Official Live | সরাসরি জি টিভি অফিসিয়াল টিভি") );
            arrayList.add(new VideoDescription("lVCG1FV3tZY", "সরাসরি চ্যানেল আই টিভি ", "Channel i TV Live | সরাসরি চ্যানেল আই টিভি") );
            arrayList.add(new VideoDescription("WGbF8-OFXdE", "সরাসরি এখন টিভি", "EKHON TV | সরাসরি এখন টিভি লাইভ") );
            arrayList.add(new VideoDescription("GUvXBRPF5CQ", "সরাসরি নিউজ24 টিভি", "News24 Live | সরাসরি নিউজ24 টিভি") );
        }

        else{
            comingFrom=getIntent().getStringExtra("comingFrom");
            if (comingFrom.contentEquals("DistrictNews"))
                arrayList.add(new VideoDescription("o3lGpY6rhQc", "চাঁদপুর জেলা নিয়ে একটি অসাধারণ গান", "চাঁদপুর জেলা নিয়ে একটি অসাধারণ গান যা না দেখলেই মিস করবেন।") );
                arrayList.add(new VideoDescription("kzeUQw84UM8", "চাঁদপুর জেলা", "History Of chandpur district in Bangladesh চাঁদপুর জেলা") );
                arrayList.add(new VideoDescription("4OOleuiFnW8", "চাঁদপুর ভ্রমণ গাইড || Chandpur tour", "চাঁদপুর ভ্রমণ গাইড || Chandpur tour || চাঁদপুর দর্শনীয় স্থান || Chandpur visiting place") );
                arrayList.add(new VideoDescription("PlN7FR_jheo", "চাঁদপুর জেলার শীর্ষ ১৪ টি দর্শনীয় স্থানসমূহ", "চাঁদপুর জেলার শীর্ষ ১৪ টি দর্শনীয় স্থানসমূহ | Chandpur Top 14 Tourist Place | Chandpur drone view |") );
                arrayList.add(new VideoDescription("DixFgSlu6zk", "কি আছে চাঁদপুরে | চলুন দেখে আসি", "কি আছে চাঁদপুরে | চলুন দেখে আসি | চাঁদপুর দর্শনীয় স্থান | Chandpur Tourist Places | Travel Video") );
                arrayList.add(new VideoDescription("wnUYNBAD3c4", "চাঁদপুরের দর্শনীয় স্থান । ইলিশের আড়ত", "চাঁদপুরের দর্শনীয় স্থান । ইলিশের আড়ত । Places to Visit in Chandpur । Episode 2 । Tiham") );
        }
        ...
        VideoDescription videoDescription = arrayList.get(0);
        String vdo_id = videoDescription.getVideoId();
            ...
            public void onClick(View v) {
                ...
                if (v!=null && v.getTag()!=null){
                    ...
                    if (tag.contains("PLAYING")){
                        ...
                        else Toast.makeText(VideoPlayer.this, "Please wait...", Toast.LENGTH_LONG).show();
    ...
    private void initMultiPlayers(){
        ...
        webYouTube = new MasterJubaYoutube(VideoPlayer.this);
        ...
        youTubeView.initialize(Config.developerKey, VideoPlayer.this);
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public MyAdapter(){
            this.inflater = (LayoutInflater) VideoPlayer.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Animation animation = AnimationUtils.loadAnimation(VideoPlayer.this, R.anim.anim_grid);
            animation.setStartOffset(position*200);
            convertView.startAnimation(animation);

            VideoDescription videoDescription = arrayList.get(position);
            String vdo_id = videoDescription.getVideoId();
            String vdo_title = videoDescription.getVideoName();
            String vdo_desciption = videoDescription.getVideoDescription();
    ...
    private void playVideo(String video_id){
        ...
        try{
            ...
            layPlayer.startAnimation(AnimationUtils.loadAnimation(VideoPlayer.this, R.anim.fade_in));
    ...
    private void playWithMasterJubaPlayer(String video_id){
        ...
        try{
            ...
            Toast.makeText(VideoPlayer.this, "Please try again!", Toast.LENGTH_LONG).show();
        }
        playingVideo = true;
    ...
    private void playNextVideo(){
        ...
        VideoDescription videoDescription = arrayList.get(PLAYING_NOW);
        String vdo_id = arrayList.get(PLAYING_NOW).getVideoId();
        playVideo(vdo_id);
    }
    ...
    private void playPreviousVideo(){
        if(PLAYING_NOW > 0){
            ...
            Toast.makeText(VideoPlayer.this, "Playing the first video", Toast.LENGTH_LONG).show();
        }
